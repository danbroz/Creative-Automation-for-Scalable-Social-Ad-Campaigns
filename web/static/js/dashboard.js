...
class Dashboard {
    ...
    updateRecentCampaigns(campaigns) {
        ...
        // If no campaigns data provided, try to get from queue
                ...
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-lg text-gray-900 font-medium">No campaigns yet</p>
                            <p class="text-sm text-gray-500 mt-2">Create your first campaign to get started!</p>
                            <button onclick="window.location.href='/create-campaign.html'" 
                                    class="mt-4 bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 shadow-sm">
                                Create Campaign
                            </button>
                        </div>
                    </td>
